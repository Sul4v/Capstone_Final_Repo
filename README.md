...
This repository contains the complete source code and data for the Capstone project, divided into two main components: the interactive web application and the text evaluation pipeline.
